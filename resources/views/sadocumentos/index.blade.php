                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        @foreach($sadocumento as $sad)
                            <tr>
                                ...
                                <td>{{ $sad->created_at->diffForHumans() }}</td>
                                <td>{{ $sad->tomo }}</td>
                                <td>
                                    @can('update',$sad)
                                        <a href="{{ route('sad-documento.edit',$sad->id) }}"><div class="col-sm-6 col-md-4 col-lg-3"><i title="Editar" class="ti-pencil"></i></div></a>
                                    @endcan
                                    <a href=""><div class="col-sm-6 col-md-4 col-lg-3"> <i title="Descargar" class="ti-download"></i></div></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
