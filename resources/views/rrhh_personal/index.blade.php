    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-warning">
                <div class="panel-heading">Digitalizaciones de Recursos humanos
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                        ...
                        @foreach($documentos as $doc)
                            <tr>
                                <td>{{ getName($doc->id) }}</td>
                                <td>{{ getSeccion($doc->seccion_id) }}</td>
                                <td>{{ $doc->created_at->format('d/m/Y') }}</td>
                                <td>
                                    <a target="_blank" href="{{ route('rrhh-documento.edit',$doc->id) }}"><div class="col-sm-6 col-md-4 col-lg-3"><i title="Editar" class="ti-pencil"></i></div></a>
                                    <a href="{{ url('storage/'. $doc->tomo.'/'. $doc->archivo) }}"><div class="col-sm-6 col-md-4 col-lg-3">
